            ...
            SliverList.list(
              children: [
                ...
                CustomSwitchListTile(
                  value: enabledHomeTopItems.contains(
                ...
                CustomSwitchListTile(
                  ...
                  onChanged: (v) =>
                      updateValue(HomeTopItems.recurrentClients, v),
                  title: AppLocalizations.of(context)!.topClients,
                  leadingIcon: Icons.smartphone_rounded,
                  padding: padding,
                ),
                CustomSwitchListTile(
                  value: enabledHomeTopItems.contains(HomeTopItems.topIps),
                  onChanged: (v) => updateValue(HomeTopItems.topIps, v),
                  title: 'IPs',
                  leadingIcon: Icons.dns_rounded,
                  padding: padding,
                ),
                CustomSwitchListTile(
                  value: enabledHomeTopItems.contains(HomeTopItems.rootDomains),
                  onChanged: (v) => updateValue(HomeTopItems.rootDomains, v),
                  title: 'Domínios raiz',
